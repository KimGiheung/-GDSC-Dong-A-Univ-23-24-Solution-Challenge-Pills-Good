...
class AutoResultPageFalse extends StatefulWidget {
  final String selectedDisease;
  final String? selectedPill;


  AutoResultPageFalse({Key? key, required this.selectedDisease, required this.selectedPill}) : super(key: key);

  @override
  _AutoResultPageFalseState createState() => _AutoResultPageFalseState();

}


class _AutoResultPageFalseState extends State<AutoResultPageFalse> {
