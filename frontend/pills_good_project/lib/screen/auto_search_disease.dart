...
class AutoSearchDisease extends StatefulWidget {
  final String selectedPill;

  AutoSearchDisease({required this.selectedPill});

  @override
  _AutoSearchDiseaseState createState() => _AutoSearchDiseaseState();


}

class _AutoSearchDiseaseState extends State<AutoSearchDisease> {
